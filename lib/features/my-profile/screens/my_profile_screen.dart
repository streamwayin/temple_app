  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileBloc, ProfileState>(
      listener: (context, state) {
        print("Listning");
        if (state.navigateToNotificationScreen == true) {
          print("Listning inside contition");
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => NotificationScreen()));
          context
              .read<ProfileBloc>()
              .add(GoToNotificationScreen(goToNotificationScreen: false));
        }
      },
                  ...
                  InkWell(
                      onTap: () async {
                        ...
                        if (await canLaunchUrl(link)) {
                          ...
                          print(
                              'failed to https://support.streamway.in/contact/');
                        }
                      },
                      child: _buildCardButton("ऐप निर्माता", Icons.people_alt)),
                  _gap(10),
                  InkWell(
                      onTap: () async {
                        Share.share(
